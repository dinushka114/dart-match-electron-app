...
const TeamRight = () => {
  return (
    <>
        ...
        <input type="number" className="score-input border-2 border-gray-600  rounded-lg bg-gray-700 text-white font-serif placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-500" id="scoreA" onInput="updateWinnerAB()" />
